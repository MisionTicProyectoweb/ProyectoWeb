...
function ListVentas(ventas,tVentas){
    return (
        <div className="font-sick flex-col" id="body">
            ...
            <div id="barraNavegador" className="mb-16 flex items-center justify-center w-full h-20 shadow-md">
            ...
            <div className="mb-8 flex items-center justify-center w-full h-20">
                ...
                <Link to="/ventas">
                    <button type="button" className="hover:bg-gray-500 focus:ring-blue-600 float-left ml-20 flex items-center p-2 rounded-lg border shadow-md">
