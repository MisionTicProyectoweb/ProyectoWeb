...
const SideBarAdmin=()=>{
    return(
        ...
        <ul className="flex flex-col justify-between h-full ">
            ...
            <li className="flex flex-col items-center ">
              <img className="w-12 cursor-pointer" src={IconoVent} alt="Logo de ventas" />
                <span className="p-1 text-gray-900 font-semibold">Gestion de Ventas</span>
            </li>
            <li className="flex flex-col items-center ">
                <img className="w-12 cursor-pointer" src={IconoProd} alt="Logo de productos" />
                <span className="p-1 text-gray-900 font-semibold">Gestion de Productos</span>
            </li>
                <Link to="/bienvenida/usuarios">
            <li className="flex flex-col items-center ">
                <img className="w-12 cursor-pointer" src={IconoUsuarios} alt="Logo de usuarios" />
